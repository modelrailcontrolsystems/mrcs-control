...
class MQClientAsync(object):
    ...
    @classmethod
    def construct(cls, exchange_name: MQMode, identity: EquipmentIdentifier, handle: Callable):
        queue = '.'.join([exchange_name.value, identity.as_json()])
    ...
    def subscription_callback(self, _channel, delivery, _props, payload):
        self._logger.info(f'subscription_callback - delivery:{delivery}')
        ...
        self._logger.info(f'subscription_callback - message:{message}')
    ...
    def connect(self):
        self._logger.info(f'connect - url:{self.URL}')
    ...
    def on_connection_open(self, connection):
        self._logger.info(f'on_connection_open - connection:{connection}')
        self._connection = connection

        channel = self._connection.channel(on_open_callback=self.on_channel_open)
        self._logger.info(f'on_connection_open - channel:{channel}')


    def on_connection_open_error(self, _unused_connection, err):
        self._logger.info(f'on_connection_open_error - err:{err}')

    # TODO: may need close_connection()

    def on_connection_closed(self, _unused_connection, reason):
        self._logger.info(f'on_connection_closed - reason:{reason}')
        self._channel = None

    # TODO: may need reconnect()

    def on_channel_open(self, channel):
        self._logger.info(f'on_channel_open - channel:{channel}')
    ...
    def add_on_channel_close_callback(self):
        self._logger.info(f'add_on_channel_close_callback')
        self._channel.add_on_close_callback(self.on_channel_closed)


    def on_channel_closed(self, _channel, reason):
        self._logger.info(f'on_channel_closed - reason:{reason}')
        self._channel = None
    ...
    def setup_exchange(self, exchange_name):
        self._logger.info(f'setup_exchange - exchange_name:{exchange_name}')
    ...
    def on_exchange_declare_ok(self, _unused_frame, userdata):
        self._logger.info(f'on_exchange_declare_ok - userdata:{userdata}')
        self.setup_queue(self.queue)


    def setup_queue(self, queue_name):
        self._logger.info(f'setup_queue - queue_name:{queue_name}')
    ...
    def on_queue_declare_ok(self, _unused_frame):
        self._logger.info(f'on_queue_declare_ok - exchange_name:{self.exchange_name}, queue_name:{self.queue}, '
    ...
    def add_on_cancel_callback(self):
        self._logger.info(f'add_on_cancel_callback')
        self._channel.add_on_cancel_callback(self.on_consumer_cancelled)


    def on_consumer_cancelled(self, method_frame):
        self._logger.info(f'on_consumer_cancelled - method_frame:{method_frame}')
        self._channel.close()


    def on_message(self, _unused_channel, basic_deliver, properties, body):
        self._logger.info(f'on_message - delivery_tag:{basic_deliver.delivery_tag}, '
                          f'app_id:{properties.app_id}, body:{body}')
        self.acknowledge_message(basic_deliver.delivery_tag)


    def acknowledge_message(self, delivery_tag):
        self._logger.info(f'acknowledge_message - acknowledge_message:{delivery_tag}')
        self._channel.basic_ack(delivery_tag)


    def start_publishing(self):
        self._logger.info(f'start_publishing')
        self._channel.confirm_delivery(self.on_delivery_confirmation)


    def publish_message(self, message: Message):
        self._logger.info(f'publish_message - message:{message}')
        ...
        self._logger.info(f'publish_message - published')


    def on_delivery_confirmation(self, method_frame):
        confirmation_type = method_frame.method.NAME.split('.')[1].lower()
        self._logger.info(f'on_delivery_confirmation - confirmation_type:{confirmation_type}')
    ...
    def __str__(self, *args, **kwargs):
        return f'MQClientAsync:{{exchange_name:{self.exchange_name}, identity:{self.identity}, queue:{self.queue}}}'
