...
class CrontabArgs(ControlArgs):
    ...
    def __init__(self, description):
        ...
        group.add_argument('-c', '--clean', action='store_true', help='discard existing scheduled events')
        group.add_argument('-r', '--report', action='store_true', help='report waiting scheduled events')
