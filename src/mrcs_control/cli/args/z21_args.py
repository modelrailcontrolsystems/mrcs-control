...
class Z21Args(MultimodeControlArgs):
    ...
    def __str__(self, *args, **kwargs):
        return (f'Z21Args:{{test:{self.test}, clean:{self.clean}, list:{self.list}, run:{self.run}, '
                f'run_save:{self.run_save}, indent:{self.indent}, verbose:{self.verbose}}}')
