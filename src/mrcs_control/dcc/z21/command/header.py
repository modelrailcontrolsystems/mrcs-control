...
class Header(IntEnum, metaclass=MetaEnum):
    ...
    LAN_RMBUS_DATA_CHANGED = 0x80
    LAN_RMBUS_GET_DATA = 0x81
    LAN_RMBUS_PROGRAMMODULE = 0x82
    LAN_SYSTEM_DATA_CHANGED = 0x84
    LAN_SYSTEM_GET_DATA = 0x85
    LAN_RAILCOM_DATA_CHANGED = 0x88
    LAN_RAILCOM_GET_DATA = 0x89
    ...
    LAN_BOOSTER_SYSTEM_DATA_CHANGED = 0xBA
    LAN_BOOSTER_SYSTEM_GET_DATA = 0xBB
    LAN_CAN_DETECTOR = 0xC4
    LAN_CAN_DEVICE_GET_DESCRIPTION = 0xC8
    LAN_CAN_DEVICE_SET_DESCRIPTION = 0xC9
    LAN_CAN_BOOSTER_SYSTEM_CHGD = 0xCA
    ...
    LAN_DECODER_SYSTEM_DATA_CHANGED = 0xDA
    LAN_DECODER_SYSTEM_GET_DATA = 0xDB
