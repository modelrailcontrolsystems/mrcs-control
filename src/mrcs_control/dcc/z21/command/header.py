...
class Header(IntEnum, metaclass=MetaEnum):
    ...
    LAN_SYSTEM_DATACHANGED = 0x84
    LAN_SYSTEM_GETDATA = 0x85
    ...
    LAN_BOOSTER_SYSTEM_DATACHANGED = 0xBA
    LAN_BOOSTER_SYSTEM_GETDATA = 0xBB
    ...
    LAN_DECODER_SYSTEM_DATACHANGED = 0xDA
    LAN_DECODER_SYSTEM_GETDATA = 0xDB
