...
class TestZ21BlockReport(unittest.TestCase):
    ...
    def test_construct_block_voltage_report_4_0(self):
        ...
        self.assertEqual('BlockVoltageReport:{block_id:BlockID:{address:5, channel:1, reporter_id:0xdb78}, '
                         'voltage:OCCUPIED_WITH_VOLTAGE}', str(obj2))
    ...
    def test_construct_block_voltage_report_5_5(self):
        ...
        obj1 = Dataset.construct_from_bytes(chars)
        obj2 = Z21BlockReport.construct_from_dataset(obj1)
        self.assertEqual('BlockVoltageReport:{block_id:BlockID:{address:6, channel:6, reporter_id:0xd489}, '
                         'voltage:OCCUPIED_WITH_VOLTAGE}', str(obj2))
    ...
    def test_construct_block_occupancy_report_03_04(self):
        ...
        obj1 = Dataset.construct_from_bytes(chars)
        obj2 = Z21BlockReport.construct_from_dataset(obj1)
        self.assertEqual('BlockOccupancyReport:{block_id:BlockID:{address:6, channel:7, reporter_id:0xd489}, '
